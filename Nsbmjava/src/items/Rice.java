...
public class Rice extends javax.swing.JFrame {
    ...
    public Rice() {
     ...
     ImageIcon imageIcon26 = new ImageIcon(new ImageIcon("C:\\Users\\Kavindu Yasintha\\Documents\\NetBeansProjects\\Nsbmjava\\src\\Images\\1547241481011.jpeg").getImage().getScaledInstance(250,250, Image.SCALE_DEFAULT));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       java.sql. Statement stmt = null;
            ...
            ResultSet rsl=stmt.executeQuery("select* from cart where  itemno= '1'");
              if(rsl.next())
              {
